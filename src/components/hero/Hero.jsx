            ...
            <div className="relative inline-block lg:mb-60 lg:pt-0 ">
              ...
              <div className="relative z-10">
                <img
                  src={HomePageImage1}
                  alt="Interior view 1"
                  className="2xl:w-[60%] lg:w-[50%] md:w-[60%] w-[50%] z-20 relative translate-x-20 sm:translate-x-0"
                />
                <img
                  src={HomePageImage4}
                  alt="Interior view 2"
                  style={{ position: 'absolute' }}
                  className="2xl:w-[100%] lg:w-[100%] w-[40%]  absolute sm:-top-1 sm:-translate-x-6 sm:translate-y-22 z-0"
                />
                <img
                  src={HomePageImage2}
                  alt="Interior view 2"
                  className="2xl:w-[50%] lg:w-[40%] md:w-[40%] w-[40%] absolute sm:top-1/2 sm:left-1/3 sm:translate-x-4 sm:translate-y-6 z-50"
                />
                <img
                  src={HomePageImage3}
                  alt="Interior view 2"
                  className="2xl:w-[80%] lg:w-[80%] w-[40%] absolute sm:top-1/5 sm:left-1/8 sm:-translate-x-6 sm:translate-y-10 z-40"
                />
              </div>
            </div>
          </div>
