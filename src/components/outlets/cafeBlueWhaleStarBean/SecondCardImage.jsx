...
const SecondCardImage = () => {
  return (
    <div className="sm:p-10 p-5">
      <div className="p-5 md:grid md:grid-cols-6 md:gap-10 flex flex-col-reverse gap-7 items-center justify-center rounded-[18px] bg-[linear-gradient(98deg,_#F9D8D7_43.75%,_#93807F_124.27%)] shadow-[0px_0px_55.7px_0px_rgba(0,0,0,0.31)]">
...
export default SecondCardImage;
