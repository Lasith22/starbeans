  ...
  return (
    <div className="px-10 py-10 flex items-center justify-center">
      <div class="shadow-custom-card p-6 bg-white rounded-lg  w-full flex flex-col items-center justify-center">
        ...
        {/* image and text  */}
        <div className="flex flex-col-reverse md:grid md:grid-cols-5 md:gap-2 gap-10 items-center justify-center py-10">
          <img
            src={ContactImg1}
            className="md:w-[80%] w-[90%] md:col-span-2"
            alt=""
          />
          <h1 className="md:col-span-3 lg:text-lg 2xl:text-2xl text-xs font-kreon font-light ">
